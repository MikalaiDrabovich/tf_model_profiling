...
def main(unused_argv):
  ...
  logging_hook = tf.train.LoggingTensorHook(
      tensors={'train_accuracy': 'train_accuracy'}, every_n_iter=10)
  
  checkpoints_hook = tf.train.CheckpointSaverHook(
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--export_dir',
      type=str,
      default='/tmp/exported_savedmodel',
  ...
  """
  sudo rm -rf /tmp/exported_savedmodel/ /tmp/mnist_model/ /tmp/checkpoints_mnist/ /tmp/profiler_data_mnist/
  sudo mkdir /tmp/exported_savedmodel/ /tmp/mnist_model/ /tmp/checkpoints_mnist/ /tmp/profiler_data_mnist/
  """
